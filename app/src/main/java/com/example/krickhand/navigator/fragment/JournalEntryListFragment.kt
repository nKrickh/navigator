 ...
 * Use the [JournalEntryListFragment.newInstance] factory method to
...
class JournalEntryListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment JournalEntryListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            JournalEntryListFragment().apply {
